...
<template>
  <div style="display: flex">
    ...
    <div style="flex: 1;">
      <!--收缩按钮-->
      <span style="font-size: 20px;cursor: pointer" :class="collapseIcon" v-on:click="$emit('collapse')"
        :title="collapseTitle"></span>

      <!--收缩按钮-->
      <span style="font-size: 20px;cursor: pointer;margin-left: 10px" class='el-icon-back' v-on:click="back"
        title="返回"></span>
