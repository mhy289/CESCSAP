      ...
      <el-dialog title="课程详情 - 学生管理" :visible.sync="courseDetailDialogVisible" width="80%">
        <el-tabs v-model="activeTab">
          <el-tab-pane label="已选学生" name="enrolled">
            ...
            <el-table :data="enrolledStudents" style="width: 100%" border stripe @selection-change="handleEnrolledSelectionChange">
          ...
          <el-tab-pane label="待选学生" name="notEnrolled">
            ...
            <el-table :data="notEnrolledStudents" style="width: 100%" border stripe @selection-change="handleNotEnrolledSelectionChange">
              <el-table-column type="selection" width="55"></el-table-column>
              <el-table-column prop="studentId" label="学号" width="100"></el-table-column>
              <el-table-column prop="name" label="姓名" width="150"></el-table-column>
              <el-table-column prop="major" label="专业" width="150"></el-table-column>
