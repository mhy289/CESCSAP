  ...
  <div style="width: 1000px; margin: 50px auto">
    <el-form :model="good">
      ...
      <el-form-item label="规格" label-width="150px">
        <el-tag closable @close="handleClose(standard)" :disable-transitions="true" style="margin-right: 10px"
          v-for="(standard, index) in standards" :key="index" @click="editStandard(index)">{{ standard.value }}</el-tag>
      ...
      <el-form-item label="商品图片" label-width="150px">
        <el-upload class="upload-demo" ref="upload" :action="'/file/upload'" :file-list="fileList"
          :on-change="handleChange" :limit="1" :on-remove="handleRemove" :on-success="handleImgSuccess"
          :auto-upload="false">
    ...
    <!-- 弹窗   -->
    <el-dialog title="规格信息" :visible.sync="dialogFormVisible" width="30%" :close-on-click-modal="false">
